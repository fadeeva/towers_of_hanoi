...
var disks = {        
    blue   : { color: "#73cad4", width: 32,  rodGap: 105 },    
    purple : { color: "#9a73d4", width: 78,  rodGap: 83  },
    orange : { color: "#d4b173", width: 122, rodGap: 61  },
    green  : { color: "#afe66e", width: 166, rodGap: 39  },
    pink   : { color: "#ed82b7", width: 210, rodGap: 17  },   
}
